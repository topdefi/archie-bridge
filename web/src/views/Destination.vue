<template>
  <div class="text-center pt-12">
    ...
    <p>
      This bridge allows you to send WARC (WARC) from {{destinationNetwork}} back to {{originNetwork}}
    </p>
...
import WrappedARC from '@/artifacts/contracts/DestinationToken.sol/WrappedARC.json'
import WARC from '@/artifacts/contracts/OriginToken.sol/WARC.json'
